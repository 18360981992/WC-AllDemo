package com.ifeng_tech.treasuryyitong.rili.view;
...
import com.ifeng_tech.treasuryyitong.rili.R;
import com.ifeng_tech.treasuryyitong.rili.adapter.DateMonthAdapter;
...
public class DatePopupWindow extends PopupWindow implements View.OnClickListener{
     ...
     *  pop框的默认展示时间
     * @param context    上下文
     * @param dateString  你需要的显示的时间   建议是当前的日期
     */
