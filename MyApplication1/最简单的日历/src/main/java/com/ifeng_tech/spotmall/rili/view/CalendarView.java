...
public class CalendarView extends View {
    ...
    private void initView() {
        ...
        DayManager.setCurrent(calendar.get((Calendar.DAY_OF_MONTH))); // 当前的日 和 月
        DayManager.setTempcurrent(calendar.get(Calendar.DAY_OF_MONTH));  //  保存当前的 日 和 月

        DayManager.setCurrentTime(calendar.get(Calendar.MONTH) + "" + calendar.get(Calendar.YEAR)); // 记录当前的时间
    }
