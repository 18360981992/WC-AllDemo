package com.ifeng_tech.spotmall.rili.view;
...
public class Day {
    ...
    private void drawWorkState(Canvas canvas, Paint paint) {
        ...
        switch (workState) {
            case 1:
                paint.setColor(0);  // 绿色  正常
                break;
            case 2:
                paint.setColor(0xFFF16269);  // 红色  出勤异常
                break;
            case 3:
                paint.setColor(0xFF3E81ED);  // 蓝色   储存外出天数
                break;
    ...
    private void drawBackground(Canvas canvas, Paint paint) {
        ...
        switch (backgroundStyle) {
            case 1:
                ...
                paint.setStyle(Paint.Style.FILL);  // 灰色的背景
                break;
            case 2:
                paint.setStyle(Paint.Style.FILL);
                paint.setColor(0xFF457BF4);  // 蓝色的背景
                break;
            case 3:
                paint.setColor(0xFF457BF4);  // 蓝色的边框
                paint.setStyle(Paint.Style.STROKE);
                paint.setStrokeWidth(3);
                break;
            case 4:
                paint.setStyle(Paint.Style.FILL);
                paint.setColor(0xFFF5F9FC);  // 浅灰色的背景  用在休息日上
                break;
        }
        //计算圆心的位置
        float cx = location_x * width + width / 2;
