...
public class ColorTemplate {
    ...
    public static final String COLOR_zhuan = "#E8571F";
    public static final String COLOR_cang = "#567CEC";
    public static final String COLOR_jian = "#0FA9A7";
    public static final String COLOR_ti = "#E8791F";

    public static final String ST_zhuan = "转赠";
    public static final String ST_cang = "仓储";
    public static final String ST_jian = "鉴定";
    public static final String ST_ti = "提货";
