package com.ifeng_tech.spotmall.jichenghtml;
...
public class TestBaseAdapter extends BaseAdapter implements
    ...
    public TestBaseAdapter(Context context) {
        ...
        mCountries = context.getResources().getStringArray(R.array.countries);  // 获取数据
    ...
    private int[] getSectionIndices() {
        ...
        char lastFirstChar = mCountries[0].charAt(0);  // ==A
