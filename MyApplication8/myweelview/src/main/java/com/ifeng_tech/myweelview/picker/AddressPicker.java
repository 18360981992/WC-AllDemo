...
import com.ifeng_tech.myweelview.listeners.OnLinkageListener;
...
//                        return;
//                    }
                    LogUtils_weel.verbose(this, "change cities after province wheeled");
...
//                        return;
//                    }
                    LogUtils_weel.verbose(this, "change counties after city wheeled");
                    selectedThirdIndex = 0;//重置县级索引
                    //根据地市获取区县
                    List<String> counties = provider.provideThirdData(selectedFirstIndex, selectedSecondIndex);
                    if (counties.size() > 0) {
