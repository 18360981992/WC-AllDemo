...
import com.ifeng_tech.myweelview.common.AppConfig;
 ...
 * blog: addapp.cn
 */
public final class LogUtils_weel {
    ...
    public static void setDebugTag(String debugTag) {
        LogUtils_weel.debugTag = debugTag;
    }
    ...
    private static int _getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(LogUtils_weel.class.getName())) {
                return --i;
            }
        }
        return -1;
