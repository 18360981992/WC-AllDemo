package com.ifeng_tech.myweelview.picker;
...
import com.ifeng_tech.myweelview.adapter.ArrayWheelAdapter;
import com.ifeng_tech.myweelview.common.LineConfig;
import com.ifeng_tech.myweelview.listeners.OnItemPickListener;
import com.ifeng_tech.myweelview.listeners.OnMoreItemPickListener;
import com.ifeng_tech.myweelview.listeners.OnMoreWheelListener;
import com.ifeng_tech.myweelview.util.LogUtils_weel;
import com.ifeng_tech.myweelview.widget.WheelListView;
import com.ifeng_tech.myweelview.widget.WheelView;
...
public class LinkagePicker extends WheelPicker {
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        ...
        for (int i = 0; i < firstData.size(); i++) {
            ...
            if (ft.contains(firstText)) {
                ...
                LogUtils_weel.verbose("init select first text: " + ft + ", index:" + selectedFirstIndex);
                break;
            }
        }
        ...
        for (int j = 0; j < secondData.size(); j++) {
            ...
            if (st.contains(secondText)) {
                ...
                LogUtils_weel.verbose("init select second text: " + st + ", index:" + selectedSecondIndex);
                break;
            }
        }
        ...
        for (int k = 0; k < thirdData.size(); k++) {
            ...
            if (tt.contains(thirdText)) {
                ...
                LogUtils_weel.verbose("init select third text: " + tt + ", index:" + selectedThirdIndex);
                break;
            }
        }
    }
    ...
    protected int[] getColumnWidths(boolean onlyTwoColumn) {
        LogUtils_weel.verbose(this, String.format(java.util.Locale.CHINA, "column weight is: %f-%f-%f"
        ...
        if(wheelModeEnable){
            ...
            firstView.setOnItemPickListener(new OnItemPickListener<String>() {
                ...
                public void onItemPicked(int i,String item) {
                    ...
                    LogUtils_weel.error(this, "change second data after first wheeled");
//                    if (!canLinkage) {
//                        return;
//                    }
                    //根据第一级数据获取第二级数据
...
//                    }
                    ...
                    LogUtils_weel.error(this, "change third data after second wheeled");
                    List<String> thirdData = provider.provideThirdData(selectedFirstIndex, selectedSecondIndex);
                    //根据第二级数据获取第三级数据
                    thirdView.setAdapter(new ArrayWheelAdapter<>(thirdData));
                    thirdView.setCurrentItem(selectedThirdIndex);
...
//                        return;
//                    }
//                    LogUtils_weel.verbose(this, "change second data after first wheeled");
...
//                    LogUtils_weel.verbose(this, "change third data after second wheeled");
