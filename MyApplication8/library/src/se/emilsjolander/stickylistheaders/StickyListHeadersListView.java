...
//        mDividerHeight = mList.getDividerHeight();
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mList.setHorizontalScrollBarEnabled(false);// (scrollBars & 0x00000100) != 0
                ...
                if (fadingEdge == 0x00001000) {
                    ...
                    mList.setHorizontalFadingEdgeEnabled(false); // mList.setHorizontalFadingEdgeEnabled(true);
                } else if (fadingEdge == 0x00002000) {
                    mList.setVerticalFadingEdgeEnabled(false);  //  mList.setVerticalFadingEdgeEnabled(true);
                ...
                // 设置滑动条的样式  0 和 1
                mList.setScrollBarStyle(1); //a.getInt(R.styleable.StickyListHeadersListView_android_scrollbarStyle, 0)
