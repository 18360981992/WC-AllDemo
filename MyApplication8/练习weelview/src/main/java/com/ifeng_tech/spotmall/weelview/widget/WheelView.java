...
package com.ifeng_tech.spotmall.weelview.widget;
...
import com.ifeng_tech.spotmall.weelview.adapter.WheelViewAdapter;
...
//		canvas.drawLine(0, center - offset, getWidth(), center - offset, paint);
		...
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_UP:
				if (!isScrollingPerformed) {
					...
					weelViewSelectJieKou.chuan(getItemView(items).toString());
				}
				break;
		}
	...
	public interface WeelViewSelectJieKou{
		void chuan(String ss);
	}
	WeelViewSelectJieKou weelViewSelectJieKou;

	public void setWeelViewSelectJieKou(WeelViewSelectJieKou weelViewSelectJieKou) {
		this.weelViewSelectJieKou = weelViewSelectJieKou;
	}
