...
public class MyAdapter extends BaseAdapter implements Filterable {
    ...
    public MyAdapter(List<PhoneContact> mList, Context context) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_phone.setText("电话："+pc.getS());
        holder.tv_email.setText("Email："+pc.getConcat());
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (pc != null) {
                        ...
                        if(pc.getName()!=null && pc.getName().startsWith(prefixString)){
                            ...
                            newValues.add(pc);
                        }else if(pc.getConcat()!=null && pc.getConcat().startsWith(prefixString)){
